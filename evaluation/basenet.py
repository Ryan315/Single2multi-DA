...
class ResClassifier(nn.Module):
    # def __init__(self, num_classes=20, num_layer=2, num_unit=20, prob=0.5, middle=1024):
    #     super(ResClassifier, self).__init__()
    #     layers = []

        # self.num_in = 2048
        # self.classifier = nn.Sequential(
        #     nn.Linear(self.num_in, middle),
        ...
        #     )
    def __init__(self, num_classes=20,num_layer = 2,num_unit=2048,prob=0.5,middle=1000):
        super(ResClassifier, self).__init__()
        layers = []
